...
public class ActivitiEventListenerParser extends BaseChildElementParser {
  ...
  public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
    EventListener listener = new EventListener(); //实例化 监听器 承载类
    BpmnXMLUtil.addXMLLocation(listener, xtr); //添加坐标信息
    ...
    listener.setEvents(xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_EVENTS)); //获取event事件并且填充对象属性
