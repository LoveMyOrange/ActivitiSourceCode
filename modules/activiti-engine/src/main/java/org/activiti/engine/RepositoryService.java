 ...
 * @author Henry Yan
 *
 * 如果流程实例被挂起, 那么存活于ACT_RU_TASK 表中的任务节点 是不能继续完成的
 *
 * 如果程序 强行完成这些存活的任务, 则报错,
...
public interface RepositoryService {
   ...
   *  suspendProcessInstances  如果为true,则该流程对应的所有流程实例会被挂起
   *  suspensionDate  流程挂起的时间, 如果该参数值为null, 则流程立刻被挂起,否则将 其添加到作业中
   */
