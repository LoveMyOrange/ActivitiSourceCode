...
public class GetNextIdBlockCmd implements Command<IdBlock> {
  ...
  public IdBlock execute(CommandContext commandContext) {
    /*
    * PropertyEntity 负责管理 ACT_GE_PROPERTY  表
    * 然后调用 findPropertyById 获取 PropertyEntity
    * 其中next.dbid 值对应 ACT_GE_PROPERTY 表 NAME_列的值
    * */
    ...
    property.setValue(Long.toString(newValue));  // 将新生成的 newValue值 更新到 ACT_GE_PROPERTY 表中
