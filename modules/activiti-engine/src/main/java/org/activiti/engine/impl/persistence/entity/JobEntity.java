...
public abstract class JobEntity implements Job, PersistentObject, HasRevision, BulkDeleteable, Serializable {
  ...
  /*
   因为 MessageEntity 和 TimerEntity 都继承  JobEntity类
   */
  ...
  /*
  * 将JobEntity添加do会话缓存中
  * 判断executionId是否为空 ,如果不为空
  * 以executionID 值为查询提哦啊见 从 ACT_RU_EXECUTIOn 表中查询数据
  * */
  public void insert() {
...
//            this 是JobEntity 对线
  ...
  public void delete() {
    Context.getCommandContext()
      .getDbSqlSession()
      .delete(this);//从JOB表中删除当前的作业信息

    // Also delete the job's exception byte array
    exceptionByteArrayRef.delete();//从actge_bytearray表中删除该作业的信息, 例如异常信息
