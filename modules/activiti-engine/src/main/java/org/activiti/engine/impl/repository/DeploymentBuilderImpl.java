...
public class DeploymentBuilderImpl implements DeploymentBuilder, Serializable {
  ...
  protected boolean isDuplicateFilterEnabled = false;//默认为false
  ...
  /*
  DeploymentEnity类中的 resources 集合 是在哪里 初始hua??
  在这里初始化
   */
  public DeploymentBuilder addInputStream(String resourceName, InputStream inputStream) {
    ...
    byte[] bytes = IoUtil.readInputStream(inputStream, resourceName);//转byte数组
    ResourceEntity resource = new ResourceEntity();//实例化
