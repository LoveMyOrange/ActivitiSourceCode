 ...
 * 
 * @author Tom Baeyens
 * 对PvmProcessElement接口中的() 实现,
 * 内部使用HashMap 维护properties集合
 * 该类在构造() 中初始化 id 和processDefinition 两个属性值
 * 创建 ActivityImpl 对象的时候 最终会调用 该类的构造()
 * 初始化 id 和processDefinition 属性
 */
